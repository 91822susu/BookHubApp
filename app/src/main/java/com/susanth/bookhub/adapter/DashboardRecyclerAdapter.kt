package com.susanth.bookhub.adapter
...
import com.susanth.bookhub.activity.DescriptionActivity
...
class DashboardRecyclerAdapter(val context: Context, val itemList: ArrayList<Book>) :
    ...
    class DashboardViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val leniarLayout: LinearLayout = view.findViewById(R.id.leniarLayout)
    ...
    override fun onBindViewHolder(holder: DashboardViewHolder, position: Int) {
        ...
        holder.leniarLayout.setOnClickListener {
